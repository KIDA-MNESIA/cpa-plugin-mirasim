	...
	return pluginapi.Plugin{
		Metadata: pluginapi.Metadata{
			...
			ConfigFields: []pluginapi.ConfigField{
				...
				{Name: "oauth-login-provider", Type: pluginapi.ConfigFieldTypeString, Description: "Mirasim sign-in provider used by --mirasim-login when the flag names none, and marked as the default button on the browser login page; the browser operator can still choose another. Defaults to github."},
